...
films = open("films.txt")
for i in films:
    f = i

for film in f.split():
        with open("film_list.txt", "a") as file:
                file.write(f'''
<figure style="text-align: center;"><a href="" target="_blank">
    <img class="film_poster" src="/static/images/{film}.jpg"><br>{film.replace('_',' ').title()}
</a></figure>\n''')